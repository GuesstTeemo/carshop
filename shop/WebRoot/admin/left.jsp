...
<div class="dtree">
	...
	<script type="text/javascript">
		...
		d.add('0104','01','汽车商品管理');
		d.add('010401','0104','汽车商品管理','${pageContext.request.contextPath}/adminProduct_findAll.action?page=1','','mainFrame');
 		d.add('0105','01','预约管理');
		d.add('010501','0105','预约管理','${pageContext.request.contextPath}/adminOrder_findAll.action?page=1','','mainFrame');
		d.add('0106','01','首页广告管理');
		d.add('010601','0106','广告管理','${pageContext.request.contextPath}//admin/advertisement/add.jsp','','mainFrame');
		document.write(d);
