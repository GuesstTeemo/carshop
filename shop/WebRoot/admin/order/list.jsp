					...
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr
								...
								<td align="center" width="5%">预约编号</td>
								<td align="center" width="10%">预约时间</td>
								<td align="center" width="10%">预约客户姓名</td>
								<td align="center" width="20%">预约客户电话</td>
								<td align="center" width="20%">预约车型</td>
								<td align="center" width="5%">车型编号</td>
								<td align="center" width="10%">预约状态</td>
								<td align="center" width="10%">接单客服信息</td>
							</tr>
							<s:iterator var="o" value="pageBean.list" status="status">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="10%"><s:property value="#o.guestname" /></td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="20%"><s:property value="#o.phone" /></td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="20%"><s:property value="#o.carname" /></td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="5%"><s:property value="#o.product.pid" /></td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="10%"><s:if test="#o.state==1">
											<a href="${ pageContext.request.contextPath }/adminOrder_updateState.action?oid=<s:property value="#o.oid"/> " onclick="alert('确认修改预约状态吗？')"><font
												color="red">客户提交预约，客服未答复</font></a>
										</s:if> <s:if test="#o.state==2">
											<font color="blue">客服已答复</font>
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="10%"><s:property value="#o.servicename" /></td>
								</tr>
							</s:iterator>
						</table>
					</td>
