			...
			<TBODY>
						...
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<s:iterator var="p" value="pageBean.list" status="status">
								<tr onmouseover="this.style.backgroundColor = '#E2E2E2'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="17%">
										<s:if test="#p.state==1">商品未审核</s:if>
										<s:if test="#p.state==2">商品审核不通过</s:if>
										<s:if test="#p.state==3">商品审核通过</s:if>
										<s:if test="#p.state==4">商品已售</s:if>
										<s:if test="#p.state==5">商品删除</s:if>
										</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
				...
				<tr align="center">
					...
					<s:if test="pageBean.page != 1">
							<a href="${ pageContext.request.contextPath }/adminProduct_findagent.action?page=1">首页</a>|
							<a href="${ pageContext.request.contextPath }/adminProduct_findagent.action?page=<s:property value="pageBean.page-1"/>">上一页</a>|
					</s:if> 
					<s:if test="pageBean.page != pageBean.totalPage">
							<a href="${ pageContext.request.contextPath }/adminProduct_findagent.action?page=<s:property value="pageBean.page+1"/>">下一页</a>|
							<a href="${ pageContext.request.contextPath }/adminProduct_findagent.action?page=<s:property value="pageBean.totalPage"/>">尾页</a>|
					</s:if> 
					</td>
				</tr>
			</TBODY>
