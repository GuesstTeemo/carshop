		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><select name="country">
						<option value="法系">法系</option>
						<option value="日系">日系</option>
						<option value="德系">德系</option>
						<option value="美系">美系</option>
						<option value="国产" selected="selected">国产</option>
				</select></td>
			</tr>
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
			...
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					汽车颜色：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="colour" value="" id="userAction_save_do_logonName" class="bg" />
				</td>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					上牌城市：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="city" value="" id="userAction_save_do_logonName" class="bg" />
				</td>
			</tr>
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
				...
				<td class="ta_01" bgColor="#ffffff"><input type="date" onfocus="MyCalendar.SetDate(this)"
					placeholder="格式：2016-05-06" name="carData" value="2015-09-24"
					id="userAction_save_do_logonName" class="bg" /></td>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					行驶里程：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="mileage" value="" id="userAction_save_do_logonName"
					class="bg" />万公里</td>
			</tr>
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
				...
				<td class="ta_01" bgColor="#ffffff"><select name="displacement">
						...
						<option value="1.6L" selected="selected">1.6L</option>
				...
				<td class="ta_01" bgColor="#ffffff"><select name="gearbox">
						...
						<option value="9速手自一体">9速手自一体</option>
						<option value="6速手自一体" selected="selected">6速手自一体</option>
			...
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					年检到期：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="date" onfocus="MyCalendar.SetDate(this)"
					name="annualInspection" value="2019-09-24"
					id="userAction_save_do_logonName" class="bg" /></td>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					保险到期：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="date" onfocus="MyCalendar.SetDate(this)"
					name="carInsurance" value="2019-09-24"
					id="userAction_save_do_logonName" class="bg" /></td>
			</tr>
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
			...
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					汽车车型：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="carSeries" value="" id="userAction_save_do_logonName"
					placeholder="比如A6L,卡罗拉" class="bg" /></td>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					汽车品牌：</td>
				<td class="ta_01" bgColor="#ffffff"><select
					name="brand">
						<s:iterator var="cs" value="csList">
							<option value="<s:property value="#cs.csname"/>"><s:property
									value="#cs.csname" /></option>
						</s:iterator>
				</select></td>
			</tr>
			...
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					<font size="3" color="#10acea">事故排查：</font>
				</td>
			</tr>
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
				...
				<td class="ta_01" bgColor="#ffffff" colspan="3"><textarea
						name="pdesc" rows="5" cols="50"></textarea></td>
			</tr>
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					<font size="2" color="red">1.排除泡水：</font>
				</td>
			</tr>
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					发动机主线束：</td>
				<td class="ta_01" bgColor="#ffffff"><select
					name="Main_engine_bundle">
						<option value="2">无此项目（功能）</option>
				...
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					防火墙隔音棉：</td>
				<td class="ta_01" bgColor="#ffffff"><select
					name="Firewall_insulation_cotton">
						<option value="2">无此项目（功能）</option>
						<option value="1" selected="selected">正常</option>
						<option value="0">异常</option>
				</select></td>
			...
			<tr>
				...
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					保险盒及ECU接口：</td>
				<td class="ta_01" bgColor="#ffffff"><select
					name="Insurance_box_and_ECU_interface">
						<option value="2">无此项目（功能）</option>
						<option value="1" selected="selected">正常</option>
						<option value="0">异常</option>
				</select></td>
			...
			<tr>
				...
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					座椅滑轨及安装螺丝：</td>
				<td class="ta_01" bgColor="#ffffff"><select
					name="slide_and_installation_screw">
						<option value="2">无此项目（功能）</option>
						<option value="1" selected="selected">正常</option>
						<option value="0">异常</option>
				</select></td>
			...
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					<font size="2" color="red">2.排除火烧：</font>
				</td>
			</tr>
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					发动机线束及橡胶制品：</td>
				<td class="ta_01" bgColor="#ffffff"><select
					name="Engine_wire_and_rubber_products">
						<option value="2">无此项目（功能）</option>
						<option value="1" selected="selected">正常</option>
						<option value="0">异常</option>
				</select></td>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					车辆覆盖件及驾驶舱：</td>
				<td class="ta_01" bgColor="#ffffff"><select
					name="Vehicle_cover_and_cockpit">
						<option value="2">无此项目（功能）</option>
						<option value="1" selected="selected">正常</option>
						<option value="0">异常</option>
				</select></td>
			...
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					<font size="2" color="red">3.排除重大碰撞：</font>
				</td>
			</tr>
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
			...
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					左前翼子板内村：</td>
				<td class="ta_01" bgColor="#ffffff"><select
					name="Left_front_wing_subboard_village">
						<option value="2">无此项目（功能）</option>
						<option value="1" selected="selected">正常</option>
						<option value="0">异常</option>
				</select></td>
			...
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					左前减震器座：</td>
				<td class="ta_01" bgColor="#ffffff"><select
					name="Left_front_shock_absorber_seat">
						<option value="2">无此项目（功能）</option>
						<option value="1" selected="selected">正常</option>
						<option value="0">异常</option>
				</select></td>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					右前减震器座：</td>
				<td class="ta_01" bgColor="#ffffff"><select
					name="Right_front_shock_absorber_seat">
						<option value="2">无此项目（功能）</option>
						<option value="1" selected="selected">正常</option>
						<option value="0">异常</option>
				</select></td>
			...
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					左后翼子板内衬：</td>
				<td class="ta_01" bgColor="#ffffff"><select
					name="Left_rear_wing_subplate_lining">
						<option value="2">无此项目（功能）</option>
						<option value="1" selected="selected">正常</option>
						<option value="0">异常</option>
				</select></td>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					右后翼子板内衬：</td>
				<td class="ta_01" bgColor="#ffffff"><select
					name="Right_rear_wing_subplate_lining">
						<option value="2">无此项目（功能）</option>
						<option value="1" selected="selected">正常</option>
						<option value="0">异常</option>
				</select></td>
			...
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					<font size="3" color="#10acea">车况系统检测：</font>
				</td>
			</tr>
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					<font size="2" color="red">1.指示灯系统检测：</font>
				</td>
			</tr>
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
			...
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					大灯高度可调：</td>
				<td class="ta_01" bgColor="#ffffff"><select
					name="Headlight_height_adjustable">
						<option value="2">无此项目（功能）</option>
						<option value="1" selected="selected">正常</option>
						<option value="0">异常</option>
				</select></td>
			...
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					<font size="2" color="red">2.随车工具检测：</font>
				</td>
			</tr>
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
			...
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					<font size="2" color="red"> 3.底盘悬挂项检测：</font>
				</td>
			</tr>
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					左前减震器：</td>
				<td class="ta_01" bgColor="#ffffff"><select
					name="Left_front_shock_absorber">
						<option value="2">无此项目（功能）</option>
						<option value="1" selected="selected">正常</option>
						<option value="0">异常</option>
				</select></td>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					右前减震器：</td>
				<td class="ta_01" bgColor="#ffffff"><select
					name="Right_front_shock_absorber">
						<option value="2">无此项目（功能）</option>
						<option value="1" selected="selected">正常</option>
						<option value="0">异常</option>
				</select></td>
			...
			<tr>
				...
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					右后减震器：</td>
				<td class="ta_01" bgColor="#ffffff"><select
					name="Rear_right_shock_absorber">
						<option value="2">无此项目（功能）</option>
						<option value="1" selected="selected">正常</option>
						<option value="0">异常</option>
				</select></td>
			...
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					<font size="2" color="red"> 4.刹车及发动机舱检测：</font>
				</td>
			</tr>
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
			...
			<tr>
				<td class="ta_01" style="WIDTH: 100%" align="center"
					bgColor="#f5fafe" colSpan="4"><s:if
						test="#session.existAdminUser.state == 1">
						...
						<INPUT class="button_ok" type="button" onclick="history.go(-1)"
							value="返回" />
						<span id="Label1"></span>
					</s:if> <s:if test="#session.existAdminUser.state == 4">
						<button type="submit" id="userAction_save_do_submit" value="确定"
							class="button_ok">&#30830;&#23450;</button>
						<FONT face="宋体">&nbsp ;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</FONT>
						<button type="reset" value="重置" class="button_cancel">&#37325;&#32622;</button>
