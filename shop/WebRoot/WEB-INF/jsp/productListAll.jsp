...
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
	<meta name="viewport" content="width=device-width, initial-scale=1">
		...
		<link rel="stylesheet" type="text/css"
			...
			<script type="text/javascript"
				src="${pageContext.request.contextPath}/js/shanxuan.js"></script>
	...
	<div class="mainbox">
		...
		<div class="comfilter-bd">
				...
				<dl class="fliter-bd clearfix sx">
					...
					<dd class="clickBrandWidget">
						<a class="on" href="#">不限</a> <a class="sx_child" href="#"
							name="brand" rel="Volkswagen" title="大众"> 大众 </a> <a
							class="sx_child" href="#" name="brand" rel="hyundai" title="现代">
							现代 </a> <a class="sx_child" href="#" name="brand" rel="toyto"
							title="丰田"> 丰田 </a> <a class="sx_child" href="#" name="brand"
							rel="audi" title="奥迪"> 奥迪 </a> <a class="sx_child" href="#"
							name="brand" rel="nissan" title="日产"> 日产 </a> <a class="sx_child"
							href="#" name="brand" rel="ford" title="福特"> 福特 </a> <a
							class="sx_child" href="#" name="brand" rel="mazda" title="马自达">
							马自达 </a> <a class="sx_child" href="#" name="brand" rel="byd"
							title="比亚迪">比亚迪 </a> <a class="sx_child" href="#" name="brand"
							rel="honda" title="本田"> 本田 </a> <a class="sx_child" href="#"
							name="brand" rel="chery" title="奇瑞"> 奇瑞 </a> <a class="sx_child"
							href="#" name="brand" rel="jili" title="吉利"> 吉利 </a> <a
							class="sx_child" href="#" name="brand" rel="chevrolet"
							title="雪佛兰"> 雪佛兰 </a> <a class="sx_child" href="#" name="brand"
							rel="kia" title="起亚"> 起亚 </a> <a class="sx_child" href="#"
							name="brand" rel="hafu" title="哈弗"> 哈弗 </a>
						<!--品牌全部-->
				...
				<dl class="fliter-bd clearfix sx">
					...
					<dd class="clickTagWidget">
						...
						<a class="on" href="#">不限</a> <a class="sx_child" href="#"
							...
							name="carSeries" rel="hafuH6" title="哈弗H6"> 哈弗H6 </a> <a
							class="sx_child" href="#" name="carSeries" rel="wulinghongguang"
							title="五菱宏光"> 五菱宏光 </a> <a class="sx_child" href="#"
							name="carSeries" rel="mazda6" title="马自达6"> 马自达6 </a> <a
							class="sx_child" href="#" name="carSeries" rel="audiA6L"
				...
				<div class="moreitem clearfix">
					...
					<dl class="selecter sx">
						...
						<dd>
							<ul>
								...
								<li><a class="sx_child" name="type" rel="samallcar"
									title="小型车"> 小型车 </a></li>
								<li><a class="sx_child" name="type" rel="suv" title="SUV">
										SUV </a></li>
								<li><a class="sx_child" name="type" rel="midsizecar"
									title="中型车"> 中型车 </a></li>
								<li><a class="sx_child" name="type" rel="bigsizecar"
									title="大型车"> 大型车 </a></li>
					...
					<dl class="selecter sx">
						...
						<dd>
							<ul>
								<li><a href="javascript:void(0);">不限</a></li>
								<li><a class="sx_child" name="gearbox" rel="shoudong"
									title="手动" href="javascript:void(0);"> 手动 </a></li>
								<li><a class="sx_child" name="gearbox" rel="auto"
									title="双离合" href="javascript:void(0);"> 双离合 </a></li>
								<li><a class="sx_child" name="gearbox" rel="shouziyiti"
					...
					<dl class="selecter sx">
						...
						<dd>
							<ul>
								<li><a href="javascript:void(0);">不限</a></li>
								<li><a class="sx_child" name="displacement" rel="1.0yixia"
									title="1.0L以下" href="javascript:void(0);"> 1.0L以下 </a></li>
								<li><a class="sx_child" name="displacement" rel="1.0dao1.6"
									title="1.0-1.6L" href="javascript:void(0);"> 1.0-1.6L </a></li>
								<li><a class="sx_child" name="displacement" rel="1.6dao2"
									title="1.6-2.0L" href="javascript:void(0);"> 1.6-2.0L </a></li>
								<li><a class="sx_child" name="displacement" rel="2dao3"
									title="2.0-3.0L" href="javascript:void(0);"> 2.0-3.0L </a></li>
								<li><a class="sx_child" name="displacement" title="3.0L以上"
									rel="3.0yishang" href="javascript:void(0);"> 3.0L以上 </a></li>
							</ul>
						</dd>
					</dl>
					<%-- <span class="span1"></span>
					...
					<dl class="selecter sx">
						...
						<dd>
							<ul>
								...
								<li><a class="sx_child" name="country" rel="domestic"
			...
			<div class="sel-menu clearfix zj">
				...
				<p class="sel-p">
					共为您找到<b><s:property value="pageBean.totalCount" /></b>辆车
				</p>
			</div>
		</div>
	...
	<div class="pagination">
		<div class="ppp">
			...
			<s:if test="pageBean.page != 1">
					<a
						href="${ pageContext.request.contextPath }/product_findAll.action?page=1"
						class="firstPage">&nbsp;</a>
					<a
						href="${ pageContext.request.contextPath }/product_findAll.action?page=<s:property value="pageBean.page-1"/>"
				...
				<s:iterator var="i" begin="1" end="pageBean.totalPage">
					<s:if test="pageBean.page != #i">
						<a
							href="${ pageContext.request.contextPath }/product_findAll.action?&page=<s:property value="#i"/>"><s:property
								value="#i" /></a>
					</s:if>
					<s:else>
				...
				<s:if test="pageBean.page != pageBean.totalPage">
					<a class="nextPage"
						href="${ pageContext.request.contextPath }/product_findAll.action?page=<s:property value="pageBean.page+1"/>">&nbsp;</a>
					<a class="lastPage"
						href="${ pageContext.request.contextPath }/product_findAll.action?page=<s:property value="pageBean.totalPage"/>">&nbsp;</a>
				</s:if>
		</div>
	</div>
	<div class="clear_fix"></div>
