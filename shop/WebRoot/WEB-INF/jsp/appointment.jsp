...
.error_new_content { width: 100%; height: 100%; text-align: center; margin: 0 auto; background-color:white; min-width: 1000px; }
...
.error_detail .error_p_title{ font-size: 26px; color: orange;}
.error_detail .error_p_con{ font-size:14px; margin-top:10px; line-height: 20px; color:orange;}


.type-2 { background: orange; text-indent: 0; height: 46px; width: 150px; border-radius: 3px; }
.type-3 { background: orange; text-indent: 0; height: 46px; width: 150px; border-radius: 3px; }
...
.type-2 i:last-of-type { opacity: 0; background: orange; color: #FFFFFF; -webkit-transition: none; transition: none; }
...
<div class="error_new_bg pr">
	<div class="error_new_content">
		<div class="error_new pa">
			<div class="fl error_new_left"><img src="images/appointment.png"></div>
			<div class="fl error_new_right">
				<div class="error_detail">
					<p class="error_p_title">客服将在30分钟内联系您看车，耐心等候哦~</p>
					
				</div>

				<p class="error_new_right_btn pr">
					<a href="${ pageContext.request.contextPath }/index.action" class="type-2 type-3">
						<i> 返回首页</i>
						<i> 返回首页 </i>
						<i> 返回首页 </i>
						<i> 返回首页 </i>
