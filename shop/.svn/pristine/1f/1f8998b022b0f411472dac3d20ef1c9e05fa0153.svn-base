 ...
 * 订单Action类
 * 
 * 项目名称：shop00 类名称：OrderAction 类描述： 创建人：Teemo 创建时间：2017年6月15日 上午11:33:07
 * 修改人：Teemo 修改时间：2017年6月15日 上午11:33:07 修改备注：
 * 
 * @version
 * 
 */
...
//		cart.clearCart();
	...
	public String chatOrder() {
		...
		order.setCarname(product.getPname());
		order.setGuestname(existUser.getName());
